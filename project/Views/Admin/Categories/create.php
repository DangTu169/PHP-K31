                ...
                <hr>
                    <form action="index.php?admin=admin&mod=category&act=store" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" placeholder="link image" name="category_thumbnail">
                        </div>
                        <div class="form-group">
                            <label for="">Description</label> <br>
                            <textarea class="form-control" name="category_description" id="" style="width: 100%" cols="50" rows="10" placeholder="Mô tả" ></textarea>
                        </div>
