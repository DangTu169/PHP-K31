<?php
    ...
    function send_email($email_recive,$name,$contents,$subject){
          ...
          $mail->Username   = "hihily41@gmail.com"; // Tên đăng nhập tài khoản Gmail
          $mail->Password   = "dangtu01"; //Mật khẩu của gmail
          $mail->SetFrom("danganhtu160901@gmail.com", "dang tu"); // Thông tin người gửi
          $mail->AddReplyTo("danganhtu160901@gmail.com", "dang tu");// Ấn định email sẽ nhận khi người dùng reply lại.
  ...
  $contents = 'hello word';
  $subject = 'Dang Tu';
  send_email("hihily41@gmail.com","Học PHP",$contents,$subject)
?>